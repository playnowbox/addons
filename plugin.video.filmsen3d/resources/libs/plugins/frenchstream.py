...
def MAINFS():
    ...
    main.addDir('Nouveautes','http://frenchstream.co/',368,art+'/new.png')
    main.addDir('Les plus vues','http://frenchstream.co/les-plus-vus',368,art+'/view.png')
    main.addDir('Les plus commentés','http://frenchstream.co/les-plus-commentees',368,art+'/popu.png')
    main.addDir('Les mieux notés','http://frenchstream.co/',368,art+'/vote.png')
    main.addDir('Films Par Genre','http://frenchstream.co/films-par-genre',371,art+'/genre.png')
...
def SEARCHFS(murl):
        ...
        if murl == 'extra':
            ...
            if (keyb.isConfirmed()):
                    ...
                    surl='http://frenchstream.co/?s='+encode
